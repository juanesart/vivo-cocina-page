    ...
    return (
        <div id="about" className="bg-primary">
            <div className="max-w-[1200px] px-4 xl:px-0 items-center grid grid-cols-1 md:grid-cols-3 gap-4 mx-auto">
                ...
                <div className="w-full border-white shadow-3xl rounded-3xl overflow-hidden block1">
                ...
                <div className="md:text-3xl md:leading-10 text-xl items-center text-justify col-span-2 py-20 font-bold text-white block1">
